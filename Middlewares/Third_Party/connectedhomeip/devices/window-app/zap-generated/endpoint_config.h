...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0xFFFF), 0x0000000B, 2, ZAP_TYPE(PERCENT100THS), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* TargetPositionLiftPercent100ths */  \
  { ZAP_SIMPLE_DEFAULT(0xFFFF), 0x0000000C, 2, ZAP_TYPE(PERCENT100THS), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* TargetPositionTiltPercent100ths */  \
  ...
  { ZAP_MIN_MAX_DEFAULTS_INDEX(1), 0x00000017, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* Mode */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 21, 318 }, \
  { ZAP_CLUSTER_INDEX(21), 5, 75 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0202,2}}
